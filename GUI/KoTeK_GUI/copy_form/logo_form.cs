...
namespace KoTeK_GUI
{
    public partial class logo_form : Form
    {
        public logo_form()
        {
            InitializeComponent();
            ...
            this.AllowDrop = true;
            this.DragEnter += logo_form_DragEnter;
            this.DragDrop += logo_form_DragDrop;
        }
        ...
        private void logo_form_DragEnter(object sender, DragEventArgs e)
        {
        ...
        private void logo_form_DragDrop(object sender, DragEventArgs e)
        {
            if (e.Data.GetDataPresent(DataFormats.FileDrop))
            {
            ...
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    bool result = KoTeK_CopyAndPack(
                        ...
                        root,             // папка для сохранения (создастся подпапка logo)
