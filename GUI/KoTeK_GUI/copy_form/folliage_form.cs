...
namespace KoTeK_GUI
{
    public partial class folliage_form : Form
    {
        public folliage_form()
        {
            InitializeComponent();

            this.AllowDrop = true;
            this.DragEnter += folliage_form_DragEnter;
            this.DragDrop += folliage_form_DragDrop;
        }
        ...
        private void folliage_form_DragEnter(object sender, DragEventArgs e)
        {
        ...
        private void folliage_form_DragDrop(object sender, DragEventArgs e)
        {
            if (e.Data.GetDataPresent(DataFormats.FileDrop))
            {
